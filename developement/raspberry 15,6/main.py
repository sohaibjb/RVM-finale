...
class MainWindow(QMainWindow):
    ...
    def listenToTriggers(self):
        ...
        widgets.btn_help.clicked.connect(self.help)
    ...
    def clock(self):
        # dt = date.today()
        dt = datetime.now()
        widgets.time_1.setText(dt.strftime("%d-%m-%Y %H:%M:%S"))
    ...
    def get_result_widget(index):
        if index == "Metal":
            return widgets.number_c
        elif index == "Plastic":
            return widgets.number_p
        else :
            return widgets.number_un
